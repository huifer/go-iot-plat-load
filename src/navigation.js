...
export const headerData = {
  ...
  actions: [{ text: 'Download', href: 'https://github.com/iot-ecology/go-iot-platform', target: '_blank' }],
};
...
export const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/iot-ecology/go-iot-platform' },
  ],
  footNote: `
